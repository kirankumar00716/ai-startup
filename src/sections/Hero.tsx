...
export const Hero = () => {
  ...
  return(
    ...
    >
      ...
      className="absolute h-[444px] w-[444px] md:w-[780px] md:h-[780px] border border-white/20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed">
      </motion.div>
      {/* End Ring 2 */}
      {/* Start Ring 3 */}
      <motion.div 
